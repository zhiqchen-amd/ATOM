...
ROCm/ATOM PR #2185. Real-checkpoint acceptance was run on four MI355X GPUs at
TP4 with whole-expert EP.
...
| Full-layer text baseline | Complete; the eager comparison path has been removed |
| Paging, batching and request-state lifecycle | Complete |
| Chat, tools and reasoning-effort protocol | Complete |
| Vision and image requests | Complete |
| Multimodal chunking and embedding lifetime | Complete; [chunking quality tradeoff](../docs/deepseek_v41_vision.md#accepted-chunking-quality-tradeoff) accepted |
| Packed cache, W4A8 experts and graph execution | Complete; [MoE precision tradeoff](../docs/deepseek_v41_performance.md#accepted-moe-numerical-change) accepted |
...
| DSpark speculation and accepted-prefix state commit | Implemented and tested; **[quality acceptance open](../docs/deepseek_v41_dspark.md#open-quality-regression)** |
...
Weights remain native FP8 32x32 or FP4 group32. Dense projections use BF16 MFMA
