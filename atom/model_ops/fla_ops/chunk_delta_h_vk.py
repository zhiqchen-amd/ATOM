...
def chunk_gated_delta_rule_fwd_kernel_h_blockdim64_vk(
    ...
    if USE_INITIAL_STATE:
        ...
        b_h1 += tl.load(
            h0 + _p_h0_1_0[:, None] * (K) + _p_h0_1_1[None, :] * (1),
        ...
        if K > 64:
            ...
            b_h2 += tl.load(
                h0 + _p_h0_2_0[:, None] * (K) + _p_h0_2_1[None, :] * (1),
        ...
        if K > 128:
            ...
            b_h3 += tl.load(
                h0 + _p_h0_3_0[:, None] * (K) + _p_h0_3_1[None, :] * (1),
        ...
        if K > 192:
            ...
            b_h4 += tl.load(
                h0 + _p_h0_4_0[:, None] * (K) + _p_h0_4_1[None, :] * (1),
    ...
    # epilogue
    if STORE_FINAL_STATE:
        _p_ht_0 = (i_v * BV) + tl.arange(0, BV)
        _p_ht_1 = (0) + tl.arange(0, 64)
        tl.store(
            ht + _p_ht_0[:, None] * (K) + _p_ht_1[None, :] * (1),
            b_h1.to(ht.dtype.element_ty),
            mask=(_p_ht_0[:, None] < (V)) & (_p_ht_1[None, :] < (K)),
        )
        if K > 64:
            _p_ht_0 = (i_v * BV) + tl.arange(0, BV)
            _p_ht_1 = (64) + tl.arange(0, 64)
            tl.store(
                ht + _p_ht_0[:, None] * (K) + _p_ht_1[None, :] * (1),
